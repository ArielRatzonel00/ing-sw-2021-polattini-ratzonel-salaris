...
public class CreateCards {
    ...
    private DevelopmentCard Blue24 = new DevelopmentCard (new int[]{0, 0, 3, 3}, new int[]{1, 0, 0, 0}, new int[]{0, 0, 0, 2, 1}, 31, DevelopmentCard.colorCard.Blue, 2, 8);
    ...
    private DevelopmentCard Yellow31 = new DevelopmentCard (new int[]{0, 0, 0, 6}, new int[]{0, 2, 0, 0}, new int[]{3, 0, 0, 0, 2}, 38, DevelopmentCard.colorCard.Yellow, 3, 9);
    private DevelopmentCard Yellow32 = new DevelopmentCard (new int[]{2, 0, 0, 5}, new int[]{1, 0, 0, 1}, new int[]{0, 2, 2, 0, 1}, 39, DevelopmentCard.colorCard.Yellow, 3, 10);
    private DevelopmentCard Yellow33 = new DevelopmentCard (new int[]{0, 0, 0, 7}, new int[]{0, 1, 0, 0}, new int[]{1, 0, 0, 0, 3}, 40, DevelopmentCard.colorCard.Yellow, 3, 11);
    private DevelopmentCard Yellow34 = new DevelopmentCard (new int[]{4, 0, 0, 4}, new int[]{0, 1, 0, 0}, new int[]{3, 0, 0, 1, 0}, 41, DevelopmentCard.colorCard.Yellow, 3, 12);

    private DevelopmentCard Purple31 = new DevelopmentCard (new int[]{6, 0, 0, 0}, new int[]{0, 0, 0, 2}, new int[]{0, 0, 3, 0, 2}, 42, DevelopmentCard.colorCard.Purple, 3, 9);
    private DevelopmentCard Purple32 = new DevelopmentCard (new int[]{5, 0, 2, 0}, new int[]{0, 1, 0, 1}, new int[]{2, 0, 2, 0, 1}, 43, DevelopmentCard.colorCard.Purple, 3, 10);
    private DevelopmentCard Purple33 = new DevelopmentCard (new int[]{7, 0, 0, 0}, new int[]{0, 0, 1, 0}, new int[]{0, 0, 0, 1, 3}, 44, DevelopmentCard.colorCard.Purple, 3, 11);
    private DevelopmentCard Purple34 = new DevelopmentCard (new int[]{4, 4, 0, 0}, new int[]{0, 0, 1, 0}, new int[]{1, 0, 0, 3, 0}, 45, DevelopmentCard.colorCard.Purple, 3, 12);

    private DevelopmentCard Blue31 = new DevelopmentCard (new int[]{0, 0, 6, 0}, new int[]{2, 0, 0, 0}, new int[]{0, 3, 0, 0, 2}, 46, DevelopmentCard.colorCard.Blue, 3, 9);
