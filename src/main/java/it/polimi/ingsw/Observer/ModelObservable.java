...
public class ModelObservable extends Observable<VirtualView> {
    ...
    public void notifyNewWarehouseFaithtrack(int PlayerIndex, Warehouse newwarehouse, FaithTrack faithTrack){
    ...
    public void notifyProductionResponse(int PlayerIndex, Warehouse newwarehouse, Strongbox newstrongbox, FaithTrack faithTrack){
