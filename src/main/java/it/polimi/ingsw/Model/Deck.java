...
/*
        ...
        ArrayList<CostOfCard> Green11Cost = new ArrayList<CostOfCard>();
        Green11Cost.add(new CostOfCard(2, ColoredMarble.ColorMarble.BLUE));
        ArrayList<CostOfCard> Green11ProductionCost = new ArrayList<CostOfCard>();
        Green11ProductionCost.add(new CostOfCard(1, ColoredMarble.ColorMarble.YELLOW));
        ArrayList<CostOfCard> Green11ProductionProfit = new ArrayList<CostOfCard>();
        ...
        ArrayList<CostOfCard> Green12Cost = new ArrayList<CostOfCard>();
        ...
        ArrayList<CostOfCard> Green12ProductionCost = new ArrayList<CostOfCard>();
        ...
        ArrayList<CostOfCard> Green12ProductionProfit = new ArrayList<CostOfCard>();
        ...
        ArrayList<CostOfCard> Green13Cost = new ArrayList<CostOfCard>();
        Green13Cost.add(new CostOfCard(2, ColoredMarble.ColorMarble.BLUE));
        Green13Cost.add(new CostOfCard(2, ColoredMarble.ColorMarble.YELLOW));
        ArrayList<CostOfCard> Green13ProductionCost = new ArrayList<CostOfCard>();
        Green13ProductionCost.add(new CostOfCard(1, ColoredMarble.ColorMarble.GREY));
        Green13ProductionCost.add(new CostOfCard(1, ColoredMarble.ColorMarble.PURPLE));
        ArrayList<CostOfCard> Green13ProductionProfit = new ArrayList<CostOfCard>();
        Green13ProductionProfit.add(new CostOfCard(2, ColoredMarble.ColorMarble.YELLOW));
        Green13ProductionProfit.add(new CostOfCard(1, ColoredMarble.ColorMarble.RED));
        DevelopmentCard Green13 = new DevelopmentCard(Green12Cost, new Production(Green12ProductionCost, Green12ProductionProfit), 2, DevelopmentCard.colorCard.Green,1, 4);
